...
def main(cfg):
    ...
    """ define logger """
    logger = Logger(fname, cfg, main_process=accelerator.is_main_process,
                    use_wandb=cfg.wandb_log, wandb_name=wandb_name, log_path=cfg.log_path)
    logger.log(OmegaConf.to_yaml(cfg))

    """ train """
    trainer(cfg, train_func, base_lm, train_loader, val_loaders, logger, accelerator, concept_extractor)
