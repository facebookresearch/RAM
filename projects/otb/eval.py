...
import pandas as pd
import argparse
from utils import model_to_tokenizer, format_metrics
...
def main():
    ...
    print('Report Macro Average between overthink splits and underthink splits, followed by F1 between the two.')
    overthink_macro_acc, overthink_macro_score, overthink_macro_tokens, underthink_macro_acc, underthink_macro_score, underthink_macro_tokens, f1 = format_metrics(out_df)
    print(f'Overthink Macro Accuracy: {overthink_macro_acc}, Overthink Macro Score: {overthink_macro_score}, Overthink Macro Tokens: {overthink_macro_tokens}')
    print(f'Underthink Macro Accuracy: {underthink_macro_acc}, Underthink Macro Score: {underthink_macro_score}, Underthink Macro Tokens: {underthink_macro_tokens}')
